...
SOURCES = \
	__init__.py \
	sentinel_upscaling.py sentinel_upscaling_dialog.py

PLUGINNAME = sentinel_upscaling

PY_FILES = \
	__init__.py \
	sentinel_upscaling.py sentinel_upscaling_dialog.py

UI_FILES = sentinel_upscaling_dialog_base.ui
...
QGISDIR=/home/sganchine/.local/share/QGIS/QGIS3/profiles/default/python/plugins/
